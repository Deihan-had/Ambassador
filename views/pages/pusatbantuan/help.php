...
<body class="bg-slate-50 text-slate-800">
    ...
    ">
        ...
        ">
            ...
            ">
                ...
                Temukan jawaban atau langsung hubungi
                tim Ambassador untuk mendapatkan bantuan.
            ...
            ">
                ...
                <input
                    type="text"
                    id="helpSearch"
                    placeholder="Cari bantuan, misalnya: cara pembelian..."
                    class="
                        w-full
                        h-14
                        pl-12
    ...
    ">
                ...
                ">
                    ...
                    <div>
                        ...
                        ">
                            ...
                            Hubungi tim Ambassador dan dapatkan
                            bantuan mengenai pesanan, pembayaran,
                            pengiriman, garansi, dan lainnya.
        ...
        <section class="mb-10">
            ...
            ">
                ...
                <button
                    onclick="openChatWithTopic('Pesanan')"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
                ...
                <button
                    onclick="openChatWithTopic('Pembayaran')"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
                ...
                <button
                    onclick="openChatWithTopic('Pengiriman')"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
                ...
                <button
                    onclick="openChatWithTopic('Garansi')"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
        ...
        <section class="mb-10">
            ...
            ">
                ...
                <a
                    href="/layanan/carapembelian.php"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
                ...
                <a
                    href="/layanan/melacakpesanan.php"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
                ...
                <a
                    href="/layanan/kebijakangaransi.php"
                    class="
                        help-card
                        bg-white
                        border border-slate-200
        ...
        ">
            ...
            <div>
                ...
                <p class="
                    ...
                    text-slate-400
                ">
                    Hubungi admin jika kamu tidak menemukan
        ...
        ">
            ...
            ">
                ...
                ">
                    ...
                    <p class="
                        ...
                        text-emerald-800
                    ">
                        Jangan bagikan password, PIN, atau kode OTP
                        kepada siapa pun.
                    </p>
            ...
            ">
                ...
                ">
                    ...
                    <button
                        onclick="sendQuickMessage('Saya ingin menanyakan pesanan saya')"
                        class="
                            whitespace-nowrap
                            px-3
                            py-2
                    ...
                    <button
                        onclick="sendQuickMessage('Saya ingin menanyakan pembayaran')"
                        class="
                            whitespace-nowrap
                            px-3
                            py-2
                    ...
                    <button
                        onclick="sendQuickMessage('Saya ingin menanyakan pengiriman')"
                        class="
                            whitespace-nowrap
                            px-3
                            py-2
                    ...
                    <button
                        onclick="sendQuickMessage('Saya ingin menanyakan garansi')"
                        class="
                            whitespace-nowrap
                            px-3
                            py-2
    ...
    <script>
        ...
        */
        ...
        ======================================================
        STATE ASISTEN TOKO
        (nghitung berapa kali maksud pelanggan gak kebaca,
        buat trigger alihin ke admin manusia)
        ======================================================
        */
        ...
        */
        ...
        function openChatWithTopic(topic) {
            ...
            setTimeout(() => {
                ...
                sendQuickMessage(
                    "Halo Admin, saya ingin bertanya tentang " + topic
                );
        ...
        */
        ...
        function simulateAdminReply(message) {
            ...
            typing.className =
                "chat-message flex items-end gap-2";
        ...
        */
        ...
        function getAdminReply(message) {
            ...
            /*
             * DETEKSI PELANGGAN YANG KELIHATAN KESEL/FRUSTRASI
             * biar responnya lebih empatik dulu sebelum masuk ke isi
             */
            ...
            const adaFrustrasi =
                kataFrustrasi.some(k => text.includes(k));

            const empati =
                adaFrustrasi
                    ? "Saya mengerti kondisinya, mari kita selesaikan bersama. "
                    : "";
            ...
            /*
             * === REFUND (dicek duluan sebelum pembayaran umum) ===
             */

            if (
                text.includes("refund") ||
                text.includes("dana kembali") ||
            ...
            /*
             * === GARANSI / KLAIM BARANG RUSAK ATAU HILANG ===
             */

            if (
                text.includes("garansi") ||
                text.includes("rusak") ||
                text.includes("cacat") ||
            ...
            /*
             * === FALLBACK ===
             * kalo 2x berturut-turut maksudnya gak kebaca,
             * alihin ke admin manusia biar gak muter-muter
             */
