...
<head>
    ...
    <title>Sign Up - Ambassador E-Commerce</title>
    <!-- Tailwind CSS CDN -->
...
<body
    class="bg-gradient-to-br from-emerald-950 via-slate-900 to-emerald-900 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-xs mt-1">Daftar sekarang untuk mulai berbelanja</p>
        </div>
        ...
        <div class="relative my-5 flex items-center justify-center">
            ...
            <span
                class="bg-white px-3 text-[11px] font-semibold text-slate-400 uppercase tracking-wider absolute">atau</span>
        </div>
        ...
        <form id="googleAuthForm" action="../../app/controllers/AuthController.php?action=google_login" method="POST"
            class="hidden">
        ...
        <div class="mt-6 pt-4 border-t border-slate-100 text-center text-xs text-slate-500 space-y-2">
            <div>
                Sudah punya akun?
                <a href="login.php" class="font-bold text-emerald-600 hover:text-emerald-700 transition-colors ml-1">
                    Sign In di sini
                </a>
            </div>
            ...
            <div>
                <a href="../../index.php"
                    class="inline-flex items-center gap-1.5 font-semibold text-slate-500 hover:text-emerald-600 transition-colors">
    ...
    <script>
        ...
        // Fungsi penangan token setelah user memilih akun Google
