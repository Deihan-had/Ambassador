...
<body class="bg-gradient-to-br from-emerald-950 via-slate-900 to-emerald-900 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    >
        ...
        <?php if (isset($_SESSION['success'])): ?>
            ...
            <div
                class="mb-5 bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs px-4 py-3 rounded-xl flex items-center gap-2.5"
            >
        ...
        <form
            action="../../app/controllers/AuthController.php?action=send_otp"
            method="POST"
            class="space-y-4"
        >
        ...
        <div class="relative my-5 flex items-center justify-center">
            ...
            <span
                class="bg-white px-3 text-[11px] font-semibold text-slate-400 uppercase tracking-wider absolute"
            >
        ...
        <form
            id="googleAuthForm"
            action="../../app/controllers/AuthController.php?action=google_login"
            method="POST"
            class="hidden"
        >
        ...
        <div
            class="mt-6 pt-4 border-t border-slate-100 text-center text-xs text-slate-500"
        >
    ...
    <script>
        ...
        function triggerGoogleLogin() {
            ...
            if (typeof google === 'undefined') {
                ...
                alert(
                    'Gagal memuat Google Login. Periksa koneksi internet Anda.'
                );
            ...
            google.accounts.id.prompt(function (notification) {
                ...
                if (
                    ...
                    alert(
                        'Login Google tidak dapat dibuka. Pastikan Google Client ID sudah benar.'
                    );
