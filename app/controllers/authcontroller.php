...
class AuthController
{
    ...
    */
    ...
    public function handleRegister()
    {
        ...
        $sukses = $this->userModel->register(
            $idUsers,
            $username,
            $email,
            $password
        ...
        if ($sukses) {
            ...
            $_SESSION['success'] =
                'Registrasi berhasil! Silakan masuk menggunakan email Anda.';
    ...
    */
    ...
    public function handleSendOtp()
    {
        ...
        */
        ...
        $stmt = mysqli_prepare(
            $this->conn,
            "SELECT id_users, email, username, role
             FROM users
             WHERE id_users = ?
             LIMIT 1"
        );
    ...
    */
    ...
    public function handleVerifyOtp()
    {
        ...
        if (
            ...
            $_SESSION['error'] =
                'Sesi OTP sudah tidak tersedia. Silakan minta OTP baru.';
        ...
        */
        ...
        if (!$otpData) {
            ...
            $_SESSION['error'] =
                'OTP tidak ditemukan. Silakan minta OTP baru.';
        ...
        */
        ...
        if (
            strtotime($otpData['expired_at']) < time()
        ) {
            ...
            $_SESSION['error'] =
                'Kode OTP sudah expired. Silakan minta OTP baru.';
    ...
    */
    ...
    public function handleGoogleLogin()
    {
        ...
        $response =
            @file_get_contents($verifyUrl);


        if ($response === false) {

            $_SESSION['error'] =
                'Gagal memverifikasi akun Google.';
        ...
        if (
            !isset($googleUserData['sub']) ||
            !isset($googleUserData['email'])
        ) {

            $_SESSION['error'] =
                'Data akun Google tidak valid.';
        ...
        $user =
            $this->userModel->findOrCreateGoogleUser(
                $googleId,
                $name,
                $email
            );
        ...
        if ($role === 'admin') {
            ...
            $_SESSION['success'] =
                'Berhasil masuk via Google! Selamat datang, Admin.';
